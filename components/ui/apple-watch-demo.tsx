...
export function AppleWatchDemo() {
  ...
  return (
    <div className="relative group">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-gray-700 via-gray-800 to-black rounded-[48px] p-3 shadow-2xl">
          ...
          <div className="w-full h-full bg-black rounded-[42px] relative overflow-hidden">
            {/* Screen Content */}
            <div className={`absolute inset-2 bg-gradient-to-b ${screens[currentScreen].bgColor} rounded-[36px] flex flex-col items-center justify-center text-white p-4`}>
      ...
      {/* Interaction Hint */}
      <motion.div 
        className="absolute -bottom-16 left-1/2 -translate-x-1/2 text-xs text-blue-400 opacity-70"
        animate={{ y: [0, -5, 0] }}
